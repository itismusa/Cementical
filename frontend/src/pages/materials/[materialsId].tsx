...
const EditMaterials = () => {
  ...
  const { materialsId } = router.query

  useEffect(() => {
    dispatch(fetch({ id: materialsId }))
  }, [materialsId])
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: materialsId, data }))
  ...
  return (
    ...
    <FormField label="MaterialType" labelFor="material_type">
        <Field name="material_type" id="material_type" component="select">
