                        ...
                        <div className={`flex rounded dark:bg-dark-900 border items-center overflow-hidden`}>
                          ...
                          >
                            ...
                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs text-gray-500'}>ReportTitle</p>
                                <p className={'line-clamp-2'}>{ item.report_title }</p>
                            </div>

                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs text-gray-500'}>Job</p>
                                <p className={'line-clamp-2'}>{ dataFormatter.jobsOneListFormatter(item.job) }</p>
                            </div>
                            ...
                            <div className={'flex-1 px-3'}>
                                ...
                                <p className={'line-clamp-2'}>{ dataFormatter.dateTimeFormatter(item.created_date) }</p>
                            </div>

                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs text-gray-500'}>ReportFile</p>
                                <p className={'line-clamp-2'}>{ item.report_file }</p>
                            </div>
